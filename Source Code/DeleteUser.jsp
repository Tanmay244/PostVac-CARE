...
<table width="100%"  border="1" cellpadding="2" cellspacing="2">
  <tr>
    <td width="25%" height="250"><%@include file="LeftMenu.jsp"%> 
    </td>
    <td width="75%">
      <!-- Logout.jsp starts-->
